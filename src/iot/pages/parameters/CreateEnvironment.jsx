...
const formValidations = {
  ...
  // Piso: si se ingresa un valor, debe ser un número positivo mayor a 0
  floor: [
    (value) => value.trim() === "" || /^\d+$/.test(value) && parseInt(value) > 0,
    "El piso debe ser positivo.",
  ],
  // Salón: si se ingresa un valor, debe ser positivo
  room: [
    (value) => value.trim() === "" || /^\d+$/.test(value) && parseInt(value) > 0,
    "El salón debe ser positivo.",
  ],
  // Capacidad: si se ingresa un valor, debe ser positivo
  capacity: [
    (value) => value.trim() === "" || /^\d+$/.test(value) && parseInt(value) > 0,
    "La capacidad debe ser positiva.",
  ],
  // Superficie: si se ingresa un valor, debe ser positivo
  surface: [
    (value) => value.trim() === "" || /^\d+$/.test(value) && parseInt(value) > 0,
...
export const CreateEnvironment = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        // return redirect("/parameters/environments");
