...
export const EnergyConsumptionDevicesChart = () => {
  ...
  useEffect(() => {
    ...
    socket.on("pzemDevices", (data) => {
      setChartData((prevState) => ({
        ...prevState,
        labels: [...prevState.labels, data.data.timestamp.slice(11, 19)],
        datasets: [
          {
    ...
    <Fragment>
      ...
      >
        ...
        >
          ...
          >
            <PowerOutlined sx={{ fontSize: "1.2rem" }} />
            <Typography variant="p" fontWeight="bold">
              Línea de Tomacorrientes
            </Typography>
          </Box>
          <Box
            sx={{
